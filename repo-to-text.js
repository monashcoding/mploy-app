...
// Configuration
const MAX_DEPTH = 3;
const EXCLUDED_DIRS = ['node_modules', 'dist', 'build', '.git', '__tests__', '__mocks__', '.vscode', '.next'];
const EXCLUDED_FILES = ['.test.', '.spec.', 'test.', 'spec.', '.d.ts', 'pnpm-lock.yaml', 'export-script.js', 'package-lock.json', 'README.md'];
...
try {
    ...
    console.log(`Repository export completed successfully in ${(endTime - startTime) / 1000}s!`);
} catch (error) {
